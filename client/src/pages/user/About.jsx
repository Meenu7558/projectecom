    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 px-6 py-12 transition-colors duration-300">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-lg leading-relaxed">
          Thank you for choosing <span className="font-semibold text-pink-500 dark:text-pink-300">Glow & Grace</span>. We're honored to be a part of your self-care story. 💖
        </p>
      </div>
    </div>
  );
